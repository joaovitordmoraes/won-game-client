...
describe('useCart', () => {
  ...
  it('should add in the cart', () => {
    ...
    //para processos que mudam estados nós precisamos utilizar o método act
    //ele é o responsável por avisar que vai mudar estados e é async
    act(() => {
